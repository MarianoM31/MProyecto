      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Vista normal con icono de caja para catalogo -->
            <li class="menu-item active">
              <a href="homeUsuario.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-box"></i> <!-- Icono de caja -->
                <div data-i18n="Analytics">Catálogo</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Autentificación</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="register.php" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Registrarse</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="forgotPassword.php" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Recuperar acceso</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              ...
              >
                ...
                <div data-i18n="Documentation">Sobre nosotros</div>
              </a>
            </li>
          </ul>
        </aside>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="#">
                        ...
                        <span class="align-middle">Mi Pérfil</span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="#">
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Ganancia</span>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title text-nowrap mb-1">$5,479</h3>
...
<div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
  <div class="card">
    <div class="row row-bordered g-0">
      <div class="col-md-8">
        <h5 class="card-header m-0 me-2 pb-3">Ganancia Total</h5>
      ...
      <div class="col-md-4">
        ...
        <div class="text-center fw-semibold pt-3 mb-2">62% Crecimiento de la compañía</div>
    ...
    <div class="col-6 mb-4">
      <div class="card">
        <div class="card-body">
          ...
          <span class="d-block mb-1">Pagos Mensuales </span>
    ...
    <div class="col-6 mb-4">
      <div class="card">
        <div class="card-body">
          ...
          <span class="fw-semibold d-block mb-1">Transacciones Mensuales</span>
          <h3 class="card-title mb-2">$8,485</h3>
...
<?php
// Simulación de productos (puedes mover esta parte a un archivo compartido si es necesario)
$productos = [
    [
    ...
    <div class="col-6 mb-4">
      <div class="card">
        <div class="card-body">
          <div class="card-title d-flex align-items-start justify-content-between">
            <div class="avatar flex-shrink-0">
              <img src="img/icons/unicons/chart-success.png" alt="Productos" class="rounded" />
            </div>
          </div>
          <span class="fw-semibold d-block mb-1">Total de Productos</span>
          <h3 class="card-title text-nowrap mb-2"><?= $totalProductos ?></h3>
          <small class="text-success fw-semibold">Actualmente disponibles</small>
        </div>
      </div>
    </div>
  </div>
...
<?php
// Simulación de clientes (puedes mover esta parte a un archivo compartido si es necesario)
$clientes = [
    [
        'id' => 'C001',
...
<div class="col-12 col-md-8 col-lg-4 order-3 order-md-2">
  <div class="row">
    ...
    <!-- Tarjeta para mostrar el total de clientes -->
    <div class="col-6 mb-4">
      <div class="card">
        <div class="card-body">
          <div class="card-title d-flex align-items-start justify-content-between">
          ...
          <span class="fw-semibold d-block mb-1">Total de Clientes</span>
          <h3 class="card-title text-nowrap mb-2"><?= $totalClientes ?></h3>
          <small class="text-primary fw-semibold">Registrados actualmente</small>
        </div>
      </div>
    </div>
  </div>
            ...
            <!-- Smell Elegance Report -->
<div class="col-12 col-lg-8 mb-4">
  <div class="card">
    <div class="card-body text-center">
      <h5 class="card-title mb-3">Smell Elegance</h5>
      <p class="mb-0">Este es tu reporte mensual</p>
    </div>
  </div>
</div>
<!--/ Smell Elegance Report -->
